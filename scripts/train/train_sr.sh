...
# Path Configuration
# ======================
# train sr一定要从含特殊vggt token的ckpt开始！！！！！！！获取带vggt token的方法：scripts/add_spatialToken.py
MODEL_PATH="<PATH_TO_INITIAL_GEOS_CHECKPOINT>"  # [ModelArguments] Initial checkpoint path
