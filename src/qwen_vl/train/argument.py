...
class ModelArguments:
    ...
    geometry_encoder_type: str = field(default="vggt")  # Type of geometry encoder ("vggt", "vggt_depth", "pi3")
...
class DataArguments:
    ...
    vsi_590k_dataRoot: str = field(default="data/media/VSI-590K")
    # vsi_590k_dataRoot: str = field(default="data/media/VSI-590K")
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    generation_max_new_tokens: Optional[int] = field(default=None)
    generation_max_length: Optional[int] = field(default=None)
